...
public final class Album extends Element {
	 ...
	 * legacy constructior to accomodate for methods and tests for MP3 that don't
	 * care about the release year of an album
	 * 
	 * @param title
	...
	/**
	 * Builds a new album with the given title, performer, release year and songs.
	 * @param title : the title of the album
	 * @param performer : the artist
	 * @param release : the release year
	 * @param songlist : a list of the song titles
	 */
	public Album(String title, String performer, int release, ArrayList<String> songlist) {
		this.name = title;
		this.performer = performer;
		this.songlist = songlist;
