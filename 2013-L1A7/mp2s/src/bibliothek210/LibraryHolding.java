...
public abstract class LibraryHolding {
	...
	/**
	 * Returns this library holding's ID number
	 * @return HoldingId
	 */
	...
	public boolean processReturn( ) {
		...
		if ( status != HoldingStatus.CheckedOut ){
			System.out.println("This Was never checked out");
			return false;
		}
	...
	/**
	 * Gets the checkout count of the holding
	...
	/**
	 * Resets the LibraryHolding IDs back to 1 for use in
	 * the library constructor.
	 * 
	 *modifies: NextHoldingId
	 */
